/// ============================== LED3 - Seite ================================
/// In dieser Datei wurde die 3.LED-Seite definiert.
...
class Led3 extends StatelessWidget {
  const Led3({super.key});

  final int lednumber = 3;
            ...
            body: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const ColorPickerPage(number: 3),
                ),
