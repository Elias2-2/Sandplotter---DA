/// ============================== Muster3 - Seite ==============================
/// In dieser Datei wurde die Werkstofftechnik-Muster-Seite definiert.
/// Auf dieser Seite kann das vordefinierte Werkstofftechnik-Muster zum
...
class Muster3 extends StatefulWidget {
  const Muster3({super.key});

  @override
  State<Muster3> createState() => _Muster3State();
}

class _Muster3State extends State<Muster3> with SingleTickerProviderStateMixin {
  ...
  static const String musterCode = 'W';
  static const int musterNummer = 3;
  static const String musterName = 'Sandplotter - Werkstofftechnik';
  static const String heroTag = 'werkstofftechnikHero';
  static const String imagePath = 'assets/img/werkstofftechnikicon.png';
