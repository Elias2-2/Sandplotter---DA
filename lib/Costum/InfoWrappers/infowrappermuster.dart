...
/// Das Menü als auch der Button der Muster-Seiten sind in dieser Datei definiert!
...
class InfoWrapperMuster extends StatelessWidget {
  const InfoWrapperMuster({super.key, required this.child, this.onInfoTap});
